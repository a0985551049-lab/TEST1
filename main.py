...
if st.session_state.get("viewing_stock") and st.session_state.get("viewing_stock_id"):
    ...
    <div style='background: #ffffff;
        ...
        <div style='color:#555555; font-size:15px; line-height:1.8; margin-top:10px;
            ...
            並分析融資融券、法人籌碼、期權氣氛等指標，研判目前市場整體投資人氛圍與國際市場連動狀況。
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    if run_market_flow:
        if not api_key:
            ...
            with st.spinner("📡 AI 正在搜尋近30日台股市場動態，分析投資人氛圍與籌碼氣氛（約 30~60 秒）..."):
    ...
    <div style='background: #ffffff;
        ...
        <div style='color:#555555; font-size:15px; line-height:1.8; margin-top:10px;
            ...
            並解讀 CPI、非農就業、失業率、FED 利率決策等總經數據，研判市場整體投資人氛圍（貪婪/恐慌）及攻守勢。
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    if run_us_market:
        if not api_key:
            ...
            with st.spinner("🌐 AI 正在搜尋近30日美股總經數據，分析市場氛圍與攻守勢（約 30~60 秒）..."):
